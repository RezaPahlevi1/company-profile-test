...
export default function BlogPreviewEditor({ content, onChange }) {
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          placeholder="Baca Insights dari Kami"
          className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          rows={2}
          placeholder="Deskripsi singkat tentang blog..."
          className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
        />
        <p className="mt-1 text-xs text-gray-500">Berapa banyak artikel terbaru yang ingin ditampilkan (maksimal 12).</p>
      </div>
    </div>
  );
}
